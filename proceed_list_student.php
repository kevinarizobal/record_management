    ...
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            <span class="d-flex justify-content-between align-items-center">
                <h1 class="mb-2 mt-1">Student to Proceed - List of Student</h1>
                        ...
                        <table class="table table-hover border text-center" style="min-width: 100px;">
                            ...
                            <tbody class="text-start" id="enrolled-student">
                              <tr>
                                ...
                                <td>
                                    <a href="" class="text-decoration-none text-success "><i class="bi bi-check-square"></i> Proceed</a>
                                </td>
                                </tr>
                            </tbody>
                        </table>
